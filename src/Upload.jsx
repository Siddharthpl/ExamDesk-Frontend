...
function Upload() {
  ...
  useEffect(() => {
    const loadSubject = async () => {
      const subjectNoteFetch = await fetch("https://examdesk-backend.onrender.com/api/allNote");
    ...
    <>
      ...
      <div className="upload">
        <div className="upload-intro">
          ...
          >
            Join our community of learners and share your knowledge with others.
            Upload your notes and previous year questions now and help fellow
            students succeed in their studies. Plus, you'll have the
            satisfaction of knowing you're making a positive impact on others'
            education.
          </p>
        </div>
        <img
