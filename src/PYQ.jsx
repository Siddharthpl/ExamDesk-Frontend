...
function PYQ() {
  ...
  const search = async () => {
    ...
    const searchedData = await fetch(
      `https://examdesk-backend.onrender.com/api/allPyq?${optionValue}=${searchBarValue}&examtype=${sortValue}`
    );
              ...
              suggestion.map((suggestion, i) => {
                return (
                  <div
                    ...
                    className="pyq-search-suggestion"
                  >
                    {suggestion}
                  </div>
                );
                  ...
                  <div key={i} className="pyq-card">
                    ...
                    <div className="pyq-card-content">
                      <div className="pyq-card-content-1">
                        <img
                          src="https://i.postimg.cc/gkzhftjX/sample-Pyq.jpg"
                          alt=""
                          srcSet=""
                        />
                      </div>
